...
//    SimpleMailMessage message =new SimpleMailMessage();
      ...
      if (rjStatus.equals("Screnned")) {
                     helper.setSubject("Job Status Change: Screnned ");
                     helper.setText("<b>"+"Dear"+" "+rjEmployeeName+","+"</b>"+"<br>"+"<br>"+"We regret to inform your referral"+" "+"<b>"+rjName +" is "+"Screnned"+" for "+"'"+jdPositionTitle+"'"+"Position"+","+"Jobcode:"+rtPositionCode+"."+"</b>"+"<br>"+
              ...
              else if(rjStatus.equals("Offered Rolledout")) {
              ...
              else if(rjStatus.equals("Offered Rejected")) {
              ...
              else if(rjStatus.equals("Offered Accepted")) {
...
//       SimpleMailMessage message=new SimpleMailMessage();
       ...
       helper.setText("Dear"+","+"<br>"+"<br>"+"Your Friend"+" "+"<b>"+empname+" ,"+"has referred "+"'"+title+"' "+"Position"+","+"Jobcode:"+positioncode+"</b>"+"<br>"+"<br>"+"<b>"+
                     "Thank you<br>" + 
                     "prodapt Recruitment Team"+"</b>",true);
       sender.send(message);
...
//    SimpleMailMessage message =new SimpleMailMessage();
    	...
    	helper.setFrom("prithiviraj.r@prodapt.com");
    	helper.setText("Dear"+","+rjEmployeeName+"<br>"+"you have successfully referred"+" "+"<b>"+rjName+"</b>"+" "+"for"+"'"+"<b>"+jdPositionTitle+"</b>"+" '"+" Position"+","+" Jobcode:"+"<b>"+rtPositionCode+"</b>"+"<br><br>"+
               "Thank you"+"<br>" + 
               "Prodapt Recruitment Team",true);
